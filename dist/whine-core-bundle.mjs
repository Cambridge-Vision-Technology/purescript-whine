...
var hashConfig = function(v) {
  var printPackageSpec = function(v1) {
    ...
    ;
    throw new Error("Failed pattern match at Whine.Bootstrap.Cache (line 293, column 24 - line 296, column 63): " + [v1.constructor.name]);
  };
...
var getPreBundledWhineCoreCache = /* @__PURE__ */ bind11(/* @__PURE__ */ exists2("dist/whine-core-bundle.mjs"))(function(bundleExists) {
  if (bundleExists) {
    return discard13(logDebug3("Found pre-bundled whine-core at dist/whine-core-bundle.mjs"))(function() {
      return pure19(new Just({
        executable: "dist/whine-core-bundle.mjs",
              ...
              "package": {
                ...
                dependencies: mapFlipped4(toUnfoldable9(dependencies))(function(v1) {
                  return singleton7(v1["value0"]["package"])(function() {
                    ...
                    ;
                    throw new Error("Failed pattern match at Whine.Bootstrap.Cache (line 149, column 35 - line 152, column 36): " + [v1.value1.constructor.name]);
                  }());
                }),
                bundle: {
                  module: mainModule,
...
var getCache = function(v) {
  ...
  if (isOnlyWhineCore) {
    return bind11(getPreBundledWhineCoreCache)(function(mPreBundled) {
      ...
      ;
      throw new Error("Failed pattern match at Whine.Bootstrap.Cache (line 68, column 7 - line 70, column 54): " + [mPreBundled.constructor.name]);
    });
  }
  ;
  return buildRuntimeCache({
